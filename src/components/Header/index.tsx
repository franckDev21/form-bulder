...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              <button className="absolute pl-4 left-0 top-1/2 -translate-y-1/2">
                <Search size={18} />
              </button>
              ...
              <input
                ...
                className="w-full bg-transparent !bg-gray-200 pl-12 py-2 rounded-md pr-4 font-medium focus:outline-none xl:w-125"
              />
            </div>
          </form>
        </div>
